...
// Конфигурация вывода для светодиода на отладочной плате STM32G030C8T6 (PC13)
...
void PORTC_13_INIT(void) {
  ...
  MODIFY_REG(GPIOC->OSPEEDR, GPIO_OSPEEDR_OSPEED13, High_speed << GPIO_OSPEEDR_OSPEED13_Pos);        // Настройка GPIOC пин 6 в режим High_speed
  MODIFY_REG(GPIOC->PUPDR, GPIO_PUPDR_PUPD13, No_pull_up_No_pull_down << GPIO_PUPDR_PUPD13_Pos);     // Настройка GPIOC пин 6 в режим High_speed
}
